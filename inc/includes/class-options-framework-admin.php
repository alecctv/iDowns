	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" id="dateabcd" data-a="<?php bloginfo('url'); ?>" data-b="<?php bloginfo('name'); ?>" data-c="<?php bloginfo('admin_email'); ?>" class="button-primary" name="update" value="<?php esc_attr_e( '保存设置', 'theme-textdomain' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '重置所有设置', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '确定重置主题设置？', 'theme-textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
